...
describe('encoding', () => {
    ...
    it('hashes eip712 structs 0', () => {
        ...
        expect(Buffer.from(domain).toString('hex')).toBe('18a89ea35edd8815ce767aaabc09a316b4fbc08f3201680390a31f7da513f3ec');
        expect(Buffer.from(message).toString('hex')).toBe('ab08501e02408252b4f674263d976f2995feb4bb8127b393baf75c54cfd86d76');
    });
    it('hashes eip712 structs 1', () => {
        ...
        const { domain, message } = hashEIP712(eip712);
        expect(Buffer.from(domain).toString('hex')).toBe('18a89ea35edd8815ce767aaabc09a316b4fbc08f3201680390a31f7da513f3ec');
        expect(Buffer.from(message).toString('hex')).toBe('a6a4e73512097abdf92fa255904b317eb37b727de8513d03877df4671e033e88');
    });

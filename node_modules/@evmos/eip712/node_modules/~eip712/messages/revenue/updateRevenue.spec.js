import { MSG_UPDATE_REVENUE_TYPES, createMsgUpdateRevenue, } from './updateRevenue';
...
describe('test MsgUpdateRevenue types and messages', () => {
    ...
    it('creates messages as expected', () => {
        ...
        const msg = createMsgUpdateRevenue(contractAddress, deployerAddress, withdrawerAddress);
        const expMsg = {
...
//# sourceMappingURL=updateRevenue.spec.js.map
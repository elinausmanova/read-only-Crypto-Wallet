import { MSG_EDIT_VALIDATOR_TYPES, createMsgEditValidator, } from './editValidator';
...
describe('test MsgEditValidator types and messages', () => {
    ...
    it('creates messages as expected', () => {
        ...
        const msg = createMsgEditValidator(validatorParams.moniker, validatorParams.identity, validatorParams.website, validatorParams.securityContact, validatorParams.details, validatorAddress, validatorParams.commissionRate, validatorParams.minSelfDelegation);
        const expMsg = {
...
//# sourceMappingURL=editValidator.spec.js.map
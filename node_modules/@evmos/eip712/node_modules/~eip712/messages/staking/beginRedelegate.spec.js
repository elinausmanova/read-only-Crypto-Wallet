import { MSG_BEGIN_REDELEGATE_TYPES, createMsgBeginRedelegate, } from './beginRedelegate';
...
describe('test MsgBeginRedelegate types and messages', () => {
    ...
    it('creates messages as expected', () => {
        ...
        const msg = createMsgBeginRedelegate(delegatorAddress, validatorSrcAddress, validatorDstAddress, amount, denom);
        const expMsg = {
...
//# sourceMappingURL=beginRedelegate.spec.js.map
import { MSG_CREATE_CLAWBACK_VESTING_ACCOUNT_TYPES, createMsgCreateClawbackVestingAccount, } from './createClawbackVestingAccount';
...
describe('test MsgCreateClawbackVestingAccount types and messages', () => {
    ...
    it('creates messages as expected', () => {
        ...
        const merge = true;
        const msg = createMsgCreateClawbackVestingAccount(funderAddress, accountAddress, startTime, lockupPeriods, vestingPeriods, merge);
        const expMsg = {
...
//# sourceMappingURL=createClawbackVestingAccount.spec.js.map
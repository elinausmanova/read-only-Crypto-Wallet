import { MSG_GENERIC_AUTHORIZATION_TYPES, createMsgGenericAuthorization, } from './genericGrant';
...
describe('test generic auth grant types and messages', () => {
    ...
    it('creates messages as expected', () => {
        ...
        const msg = createMsgGenericAuthorization(granter, grantee, typeUrl, expiration);
        const expMsg = {
...
//# sourceMappingURL=genericGrant.spec.js.map
...
export function createMsgGenericAuthorization(sender, botAddress, typeUrl, expires) {
    const date = new Date();
...
export function createMsgRevokeGenericAuthorization(sender, botAddress, typeUrl) {
    return {

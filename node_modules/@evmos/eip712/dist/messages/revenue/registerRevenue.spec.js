import { MSG_REGISTER_REVENUE_TYPES, createMsgRegisterRevenue, } from './registerRevenue';
...
describe('test MsgRegisterRevenue types and messages', () => {
    ...
    it('creates messages as expected', () => {
        ...
        const msg = createMsgRegisterRevenue(contractAddress, deployerAddress, withdrawerAddress, nonces);
        const expMsg = {
...
//# sourceMappingURL=registerRevenue.spec.js.map
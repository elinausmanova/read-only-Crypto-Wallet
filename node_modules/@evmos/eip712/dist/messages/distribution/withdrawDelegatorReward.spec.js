import { MSG_WITHDRAW_DELEGATOR_REWARD_TYPES, createMsgWithdrawDelegatorReward, } from './withdrawDelegatorReward';
...
describe('test MsgWithdrawDelegatorReward types and messages', () => {
    ...
    it('creates messages as expected', () => {
        ...
        const msg = createMsgWithdrawDelegatorReward(delegatorAddress, validatorAddress);
        const expMsg = {
...
//# sourceMappingURL=withdrawDelegatorReward.spec.js.map
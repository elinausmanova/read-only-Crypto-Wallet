import { MSG_CREATE_VALIDATOR_TYPES, createMsgCreateValidator, } from './createValidator';
...
describe('test MsgCreateValidator types and messages', () => {
    ...
    it('creates messages as expected', () => {
        ...
        const msg = createMsgCreateValidator(validatorDescription, validatorCommission, validatorParams.minSelfDelegation, delegatorAddress, validatorAddress, amount, denom, pubkey);
        const expMsg = {
...
//# sourceMappingURL=createValidator.spec.js.map
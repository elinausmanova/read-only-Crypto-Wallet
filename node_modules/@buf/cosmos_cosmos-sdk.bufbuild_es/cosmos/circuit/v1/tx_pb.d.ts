...
import type { Permissions } from "./types_pb.js";
 ...
 */
export declare class MsgAuthorizeCircuitBreaker extends Message<MsgAuthorizeCircuitBreaker> {
  /**
 ...
 */
export declare class MsgAuthorizeCircuitBreakerResponse extends Message<MsgAuthorizeCircuitBreakerResponse> {
  /**
 ...
 */
export declare class MsgTripCircuitBreaker extends Message<MsgTripCircuitBreaker> {
  /**
 ...
 */
export declare class MsgTripCircuitBreakerResponse extends Message<MsgTripCircuitBreakerResponse> {
  /**
   * @generated from field: bool success = 1;
   */
  success: boolean;
 ...
 */
export declare class MsgResetCircuitBreaker extends Message<MsgResetCircuitBreaker> {
  /**
 ...
 */
export declare class MsgResetCircuitBreakerResponse extends Message<MsgResetCircuitBreakerResponse> {
  /**
   * @generated from field: bool success = 1;
   */
  success: boolean;

 ...
 */
export const BlockMetadata = proto3.makeMessageType(
 ...
 *
 * @generated from message cosmos.store.v1beta1.BlockMetadata.DeliverTx
 */
export const BlockMetadata_DeliverTx = proto3.makeMessageType(
  "cosmos.store.v1beta1.BlockMetadata.DeliverTx",
  () => [
    { no: 1, name: "request", kind: "message", T: RequestDeliverTx },
    { no: 2, name: "response", kind: "message", T: ResponseDeliverTx },
  ],
  {localName: "BlockMetadata_DeliverTx"},
);

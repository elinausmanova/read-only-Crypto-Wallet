...
export declare class BlockMetadata extends Message<BlockMetadata> {
  ...
  /**
   * @generated from field: repeated cosmos.store.v1beta1.BlockMetadata.DeliverTx deliver_txs = 3;
   */
...
export declare class BlockMetadata_DeliverTx extends Message<BlockMetadata_DeliverTx> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "cosmos.store.v1beta1.BlockMetadata.DeliverTx";
  static readonly fields: FieldList;

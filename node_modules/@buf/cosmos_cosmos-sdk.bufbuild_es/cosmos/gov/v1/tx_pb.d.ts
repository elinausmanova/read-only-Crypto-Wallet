 ...
 */
export declare class MsgCancelProposal extends Message<MsgCancelProposal> {
  /**
   * @generated from field: uint64 proposal_id = 1;
   */
  proposalId: bigint;
 ...
 */
export declare class MsgCancelProposalResponse extends Message<MsgCancelProposalResponse> {
  /**
   * @generated from field: uint64 proposal_id = 1;
   */
  proposalId: bigint;
